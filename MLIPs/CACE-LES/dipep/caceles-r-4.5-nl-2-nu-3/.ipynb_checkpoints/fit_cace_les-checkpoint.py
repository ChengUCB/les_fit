...
collection2 = cace.tasks.get_dataset_from_xyz(train_path='../data-sets/spice-dipep-dipolar_val.xyz',
                                 valid_fraction=0.000001,
                                 seed=1,
                                 cutoff=cutoff,
                                 data_key={'energy': 'energy', 'forces':'forces'}, 
...
valid_loader = cace.tasks.load_data_loader(collection=collection2,
                              data_type='train',
                              batch_size=4,
                              )
